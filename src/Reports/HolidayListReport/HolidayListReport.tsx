  ...
  return (
    <div>
      ...
      <div className="  col-md-12 bg-mainclass">
        ...
        <iframe title="Holiday List and PTO Tracker" width="1140" height="541.25" src="http://colo-sqlrptqa/reports/powerbi/CPT/Holiday%20List%20and%20PTO%20Tracker?rs:embed=true"></iframe>
      </div>
    </div>
  );
};
